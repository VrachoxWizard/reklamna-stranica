    ...
    <Section className="bg-stone-50 pt-16 pb-12 md:pt-24 md:pb-20 border-b border-stone-200">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="flex flex-col items-start text-left">
          <div className="flex items-center gap-2 text-sm font-medium text-stone-800 mb-6">
            <MapPin className="w-5 h-5 text-emerald-700" />
            <span className="uppercase tracking-wider">Zagreb i okolica</span>
          </div>
          
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold tracking-tight text-stone-950 mb-6 leading-[1.2] lg:leading-tight">
            Sporo računalo, Windows problemi ili trebate IT pomoć u Zagrebu?
          </h1>
          
          <p className="text-lg sm:text-xl leading-relaxed text-stone-900 mb-8 max-w-xl text-balance">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-10 w-full sm:w-auto">
            <a href="#kontakt" className="inline-flex w-full sm:w-auto items-center justify-center rounded-lg bg-emerald-700 px-6 py-3.5 text-base font-semibold text-white hover:bg-stone-800 transition-colors text-center min-h-[48px] focus:outline-none focus:ring-2 focus:ring-emerald-700 focus:ring-offset-2">
              Pošalji problem
              <ArrowRight className="ml-2 h-5 w-5" />
            </a>
            <a href="#cijene" className="inline-flex w-full sm:w-auto items-center justify-center rounded-lg bg-stone-50 border border-stone-200 px-6 py-3.5 text-base font-semibold text-stone-950 hover:bg-stone-100 transition-colors text-center min-h-[48px] focus:outline-none focus:ring-2 focus:ring-stone-900 focus:ring-offset-2">
              Pogledaj cijene
            </a>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6 text-sm text-stone-800 w-full">
            {[
