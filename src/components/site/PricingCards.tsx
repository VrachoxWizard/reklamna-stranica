  ...
  return (
    <Section id="cijene" className="bg-stone-50 py-16 md:py-24 border-t border-stone-200">
      <div className="mb-10 max-w-3xl px-6 md:px-0">
        ...
        <p className="text-lg md:text-xl text-stone-600 leading-relaxed border-l-[3px] border-stone-300 pl-4">
        ...
        {packages.map((pkg, index) => {
          ...
          <div 
            ...
            className={`relative flex-none w-[85vw] sm:w-[320px] md:w-auto flex flex-col p-5 md:p-6 rounded-lg transition-all duration-200 snap-center ${
              isFeatured 
                ? 'bg-white border-[2px] border-teal-700' 
          ...
          >
            ...
            <div className="mb-5">
              ...
              <div className="text-2xl md:text-3xl font-extrabold text-stone-900 mb-3">
                {pkg.price}
              </div>
              <p className="text-sm text-stone-600 leading-relaxed min-h-[60px]">
                {pkg.description}
              </p>
            </div>
              ...
              <ul className="space-y-2.5 mb-6">
                {pkg.includes.map((item, i) => (
                  <li key={i} className="flex items-start gap-2.5 text-sm">
                    <Check className="w-4 h-4 mt-0.5 shrink-0 text-teal-700" />
            ...
            <div className="mt-auto">
              <a href="#kontakt" className={`flex w-full min-h-[44px] items-center justify-center text-center px-4 rounded-lg font-bold text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                isFeatured 
                  ...
                  : 'bg-stone-50 border border-stone-200 text-stone-900 hover:bg-stone-100 focus:ring-stone-900'
              }`}>
                Zatraži ovu uslugu
              </a>
            </div>
      ...
      <div className="mt-4 p-5 md:p-6 bg-white border border-stone-200 rounded-lg flex flex-col md:flex-row gap-4 items-start max-w-4xl mx-6 md:mx-0">
        <Info className="w-6 h-6 text-stone-400 shrink-0 mt-0.5" />
        <div>
          <p className="text-stone-700 leading-relaxed">
            <span className="font-bold text-stone-900">Važna napomena: </span>
