...
export function HonestySection() {
  return (
    <Section className="bg-white py-16 md:py-24 border-t border-emerald-200" id="pristup">
      <div className="max-w-4xl mx-auto px-6">
        <div className="bg-emerald-50 p-8 md:p-12 rounded-lg border border-emerald-200 grid grid-cols-1 md:grid-cols-[1fr_280px] gap-8 items-start">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-emerald-950 leading-snug">
          ...
          {/* Right — Image */}
          <div className="relative w-full h-[320px] md:h-full md:min-h-[400px] rounded-lg overflow-hidden border border-emerald-200/50 shadow-sm md:mt-2">
            <Image 
