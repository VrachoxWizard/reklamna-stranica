    ...
    <Section id="usluge" className="bg-white py-20 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="rounded-lg bg-emerald-50 lg:col-span-7 flex flex-col justify-center border border-emerald-200/80 overflow-hidden">
            <div className="relative w-full h-[240px] border-b border-emerald-200/80">
              <Image 
            ...
            <div className="p-8 sm:p-10">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-sm bg-emerald-200 text-emerald-800">
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-emerald-950">Ubrzavanje i oživljavanje Windowsa</h3>
              <p className="mt-4 text-emerald-900 leading-relaxed text-lg">
          ...
          {/* Card 2: Medium */}
          <div className="rounded-lg bg-emerald-50/50 p-8 sm:p-10 lg:col-span-5 border border-emerald-200/80 flex flex-col">
            <h3 className="text-xl font-bold text-emerald-950">Spašavanje fileova (Backup)</h3>
            <p className="mt-4 text-emerald-900 leading-relaxed flex-grow">
          ...
          {/* Card 3: Medium */}
          <div className="rounded-lg bg-emerald-50/50 p-8 sm:p-10 lg:col-span-4 border border-emerald-200/80">
            <h3 className="text-xl font-bold text-emerald-950">Početno slaganje programa</h3>
            <p className="mt-4 text-emerald-900 leading-relaxed">
          ...
          <div className="rounded-lg bg-emerald-50/50 p-8 sm:p-10 lg:col-span-4 border border-emerald-200/80">
            <h3 className="text-xl font-bold text-emerald-950">Pomoć oko interneta i opreme</h3>
            <p className="mt-4 text-emerald-900 leading-relaxed">
          ...
          {/* Card 5: Medium */}
          <div className="rounded-lg bg-emerald-50/50 p-8 sm:p-10 lg:col-span-4 border border-emerald-200/80">
            <h3 className="text-xl font-bold text-emerald-950">Prijevara i virus čišćenje</h3>
            <p className="mt-4 text-emerald-900 leading-relaxed">
