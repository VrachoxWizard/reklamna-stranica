    ...
    <Section id="usluge" className="bg-white py-20 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="rounded-lg bg-[#FAF9F6] lg:col-span-7 flex flex-col justify-center border border-neutral-200/80 overflow-hidden">
            <div className="relative w-full h-[240px] border-b border-neutral-200/80">
              <Image 
            ...
            <div className="p-8 sm:p-10">
              ...
              <h3 className="text-2xl font-bold text-neutral-900">Ubrzavanje i oživljavanje Windowsa</h3>
          ...
          {/* Card 2: Medium */}
          <div className="rounded-lg bg-neutral-50 p-8 sm:p-10 lg:col-span-5 border border-neutral-200/80 flex flex-col">
            <h3 className="text-xl font-bold text-neutral-900">Spašavanje fileova (Backup)</h3>
          ...
          {/* Card 3: Medium */}
          <div className="rounded-lg bg-neutral-50 p-8 sm:p-10 lg:col-span-4 border border-neutral-200/80">
            <h3 className="text-xl font-bold text-neutral-900">Početno slaganje programa</h3>
          ...
          <div className="rounded-lg bg-[#FAF9F6]/50 p-8 sm:p-10 lg:col-span-4 border border-neutral-200/80">
            <h3 className="text-xl font-bold text-neutral-900">Pomoć oko interneta i opreme</h3>
            <p className="mt-4 text-neutral-600 leading-relaxed">
          ...
          {/* Card 5: Medium */}
          <div className="rounded-lg bg-neutral-50 p-8 sm:p-10 lg:col-span-4 border border-neutral-200/80">
            <h3 className="text-xl font-bold text-neutral-900">Prijevara i virus čišćenje</h3>
            <p className="mt-4 text-neutral-600 leading-relaxed">
